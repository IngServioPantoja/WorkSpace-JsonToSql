 ...
 * <ul>
 *   <li>{@link jsonToSql.impl.AttributeNameImpl#getOldField <em>Old Field</em>}</li>
 *   <li>{@link jsonToSql.impl.AttributeNameImpl#getFinalField <em>Final Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeNameImpl extends MinimalEObjectImpl.Container implements AttributeName {
	...
	protected EClass eStaticClass() {
		return JsonToSqlPackage.Literals.ATTRIBUTE_NAME;
	}
	...
	public void setOldField(String newOldField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonToSqlPackage.ATTRIBUTE_NAME__OLD_FIELD, oldOldField, oldField));
	}
	...
	public Field getFinalField() {
		if (finalField != null && finalField.eIsProxy()) {
			...
			if (finalField != oldFinalField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsonToSqlPackage.ATTRIBUTE_NAME__FINAL_FIELD, oldFinalField, finalField));
			}
		}
		return finalField;
	}
	...
	public void setFinalField(Field newFinalField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsonToSqlPackage.ATTRIBUTE_NAME__FINAL_FIELD, oldFinalField, finalField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsonToSqlPackage.ATTRIBUTE_NAME__OLD_FIELD:
				return getOldField();
			case JsonToSqlPackage.ATTRIBUTE_NAME__FINAL_FIELD:
